        ...
        <div className="flex h-screen overflow-hidden bg-slate-50 font-sans">
            ...
            <aside className={`fixed inset-y-0 left-0 z-50 w-64 flex flex-col bg-white border-r border-slate-100 shadow-sm transition-transform duration-300 lg:relative lg:translate-x-0 ${showMobileSidebar ? 'translate-x-0' : '-translate-x-full'}`}>
                <div className="px-6 py-8 border-b border-slate-100">
                    <div className="flex items-center gap-3">
                        <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-teal-600 text-white shadow-lg shadow-teal-500/20">
                            <BookOpen className="h-4 w-4" />
                        </div>
                        <div>
                            <p className="text-sm font-bold text-slate-900">Faculty Portal</p>
            ...
            <main className="flex-1 overflow-y-auto flex flex-col">
                ...
                <div className="sticky top-0 z-30 flex h-12 items-center gap-3 bg-white/90 backdrop-blur-xl border-b border-slate-100 px-4 lg:hidden">
                    ...
                    <span className="text-xs font-bold text-teal-600">Faculty Portal</span>
                </div>
                {loading ? (
                    ...
                    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="max-w-6xl mx-auto space-y-8 p-4 sm:p-6 md:p-8">
                        ...
                        <div className="flex flex-wrap items-center justify-between gap-4">
                            <div>
                                <p className="text-xs font-bold uppercase tracking-wider text-teal-600 mb-1">Faculty Portal</p>
                            ...
                            <div className="flex items-center gap-4">
                                <button
                                    ...
                                    disabled={refreshing}
                                    className="h-10 px-4 rounded-xl border border-slate-200 bg-white text-slate-500 text-xs font-bold hover:bg-slate-50 transition-all flex items-center gap-2 disabled:opacity-50"
                                >
                                ...
                                {activeTab === 'overview' && (
                                    <button
                                        ...
                                        className="h-10 px-5 rounded-xl bg-teal-600 text-white text-xs font-bold hover:bg-teal-700 transition-all shadow-lg shadow-teal-500/20 flex items-center gap-2"
                                    >
                                ...
                                <div className="rounded-2xl bg-white border border-slate-100 p-8 shadow-sm">
                                    ...
                                    {students.filter(s => !reports.find(r => String(r.student?._id) === String(s._id))).map(s => (
                                        <div key={s._id} className="flex items-center justify-between py-4 border-b border-slate-100 last:border-0">
                                            ...
                                            <button onClick={() => openReportModal(s)} className="flex items-center gap-1.5 rounded-lg bg-teal-600 px-4 py-2 text-xs font-bold text-white hover:bg-teal-700 transition-all shadow-sm">
